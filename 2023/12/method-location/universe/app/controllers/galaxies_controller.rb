class GalaxiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @galaxy.save
        format.html { redirect_to galaxy_url(@galaxy), notice: "Galaxy was successfully created." }
  ...
  def update
    respond_to do |format|
      if @galaxy.update(galaxy_params)
        format.html { redirect_to galaxy_url(@galaxy), notice: "Galaxy was successfully updated." }
